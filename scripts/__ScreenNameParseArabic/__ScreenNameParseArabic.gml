...
function __ScreenNameParseArabic(_string)
{
    static _joinPrevMap = __ScreenNameGlyphData().arabicJoinPrevMap;
    static _joinNextMap = __ScreenNameGlyphData().arabicJoinNextMap;
    static _initialMap  = __ScreenNameGlyphData().arabicInitialMap;
    static _medialMap   = __ScreenNameGlyphData().arabicMedialMap;
    static _finalMap    = __ScreenNameGlyphData().arabicFinalMap;
    static _isolatedMap = __ScreenNameGlyphData().arabicIsolatedMap;
    ...
    __ScreenNameGlyphArrayBiDiReorder(_outGlyphArray, true, false);
    
    return __ScreenNameRecompose(_outGlyphArray, false);
}