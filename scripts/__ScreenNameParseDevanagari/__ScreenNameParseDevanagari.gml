...
function __ScreenNameParseDevanagari(_inString)
{
    static _matraLookupMap = __ScreenNameGlyphData().devanagariMatraMap;
    static _lookupMap      = __ScreenNameGlyphData().devanagariLookupMap;
    
    var _charArray = __ScreenNameDecompose(_inString);
    ...
    return __ScreenNameRecompose(_charArray);
}