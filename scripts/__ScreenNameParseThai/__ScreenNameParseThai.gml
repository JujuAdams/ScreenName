...
function __ScreenNameParseThai(_string)
{
    static _baseMap          = __ScreenNameGlyphData().thaiBaseMap;
    static _baseDescenderMap = __ScreenNameGlyphData().thaiBaseDescenderMap;
    static _baseAscenderMap  = __ScreenNameGlyphData().thaiBaseAscenderMap;
    static _topMap           = __ScreenNameGlyphData().thaiTopMap;
    static _lowerMap         = __ScreenNameGlyphData().thaiLowerMap;
    static _upperMap         = __ScreenNameGlyphData().thaiUpperMap;
    ...
    return __ScreenNameRecompose(_outArray, false);
}